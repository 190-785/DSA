<h1>3681 - Maximum Area Rectangle With Point Constraints I</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-area-rectangle-with-point-constraints-i/">maximum-area-rectangle-with-point-constraints-i</a></h2><p>You are given an array <code>points</code> where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents the coordinates of a point on an infinite plane.</p>
