<h1>3502 - Count Substrings With K-Frequency Characters I</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/count-substrings-with-k-frequency-characters-i/">count-substrings-with-k-frequency-characters-i</a></h2><p>Given a string <code>s</code> and an integer <code>k</code>, return the total number of <span data-keyword="substring-nonempty">substrings</span> of <code>s</code> where <strong>at least one</strong> character appears <strong>at least</strong> <code>k</code> times.</p>
